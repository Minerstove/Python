...
try:
    from student_solution import sugar_rush_racetrack as student_sol
except (ModuleNotFoundError, ImportError):
    student_sol = None

from OJ.model_solution import sugar_rush_racetrack as model_sol
...
def wrapper(func, args, queue):
    try:
        result = func(*args)
        if result==None: raise NotImplementedError('function does not exist')
